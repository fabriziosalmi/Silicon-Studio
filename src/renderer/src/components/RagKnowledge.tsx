                ...
                {activeTab === 'collections' && (
                    <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <Card className="p-5 flex items-center gap-4 border-l-4 border-l-blue-500 bg-[#18181B] shadow-lg">
                                <div className="w-12 h-12 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center">
                                    <Database className="w-6 h-6 text-blue-400" />
                                </div>
                                <div>
                                    <p className="text-[11px] font-bold text-gray-500 tracking-widest uppercase mb-0.5">Total Collections</p>
                                    <p className="text-2xl font-bold font-mono text-gray-200">{collections.length}</p>
                                </div>
                            </Card>
                            <Card className="p-5 flex items-center gap-4 border-l-4 border-l-purple-500 bg-[#18181B] shadow-lg">
                                <div className="w-12 h-12 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                                    <Brain className="w-6 h-6 text-purple-400" />
                                </div>
                                <div>
                                    <p className="text-[11px] font-bold text-gray-500 tracking-widest uppercase mb-0.5">Total Embedded Chunks</p>
                                    <p className="text-2xl font-bold font-mono text-gray-200">10,670</p>
                                </div>
                            </Card>
                            <Card className="p-5 flex items-center gap-4 border-l-4 border-l-green-500 bg-[#18181B] shadow-lg">
                                <div className="w-12 h-12 rounded-2xl bg-green-500/10 border border-green-500/20 flex items-center justify-center">
                                    <Database className="w-6 h-6 text-green-400" />
                                </div>
                                <div>
                                    <p className="text-[11px] font-bold text-gray-500 tracking-widest uppercase mb-0.5">Embedding Model</p>
                                    <p className="text-lg font-bold text-green-300">nomic-embed-text</p>
                                </div>
                            </Card>
                        </div>
